...
%%  [] = D2_10(...)
%%
%%  "D2_10" sets variables or options as global variable 设置输出的变量
%%
%%  [input]
%%   (stype, ...)
%%
...
%%      1: non-digaonl
%%
%%   ('D2_8', nimp) -> set length of D2_8 response
%%                        (default: 12)
%%
...
function D2_10(stype, arg1, arg2, arg3)
